...
// @PageableDefault(size = 10, direction = Sort.Direction.DESC, sort = "id")
// Pageable pageable) {
// User sessionUser = (User) session.getAttribute("sessionUser");
// var modelData = documentService.과정목록(sessionUser, pageable);
// var respDTOs =
// modelData.coursePage().getContent().stream().map(DocumentResponse.CourseDTO::new).toList();
...
// var respDTOs =
// modelData.subjects().stream().map(DocumentResponse.SubjectDTO::new).toList();
// model.addAttribute("models", respDTOs);
// return "document/subject-list";
// }

// @GetMapping("/api/document-menu/subject/{subjectId}")
// public String subjectDetail(@PathVariable("subjectId") Long subjectId, Model
// model) {
...
// var respDTO = new DocumentResponse.No1McqDTO(modelData.subject(),
// modelData.questions(),
// modelData.teacher().getSign(), modelData.paper());
// // DB에 밀어넣기
// model.addAttribute("model", respDTO);
// return "document/no1-mcq";
// } else {
// var respDTO = new DocumentResponse.No1RubricDTO(modelData.subject(),
// modelData.questions(),
// modelData.teacher().getSign(), modelData.paper());
// model.addAttribute("model", respDTO);
...
// public ResponseEntity<?> no2(@PathVariable("subjectId") Long subjectId, Model
// model)
// throws JsonProcessingException {
// var modelData = documentService.no2(subjectId);

// if (modelData.evaluationWay() == EvaluationWay.MCQ) {
// var respDTO = new DocumentResponse.No2McqDTO(modelData.subject(),
// modelData.questions());
// return ResponseEntity.ok(respDTO);
// } else {
// var respDTO = new DocumentResponse.No2RubricDTO(modelData.subject(),
// modelData.questions());
// return ResponseEntity.ok(respDTO);
// }
// }
...
// if (modelData.paper().getEvaluationWay() == EvaluationWay.MCQ) {
// var respDTO = new DocumentResponse.No3McqDTO(modelData.paper(),
// modelData.elements(), modelData.questions(),
// modelData.teacher());
// model.addAttribute("model", respDTO);
// return "document/no3-mcq";
// } else {
// var respDTO = new DocumentResponse.No3RubricDTO(modelData.paper(),
// modelData.questions(),
// modelData.teacher());
// model.addAttribute("model", respDTO);
...
// @RequestParam(value = "currentIndex", defaultValue = "0") Integer
// currentIndex) {
// var modelData = documentService.no4(subjectId, currentIndex);

// if (modelData.exam().getPaper().getEvaluationWay() == EvaluationWay.MCQ) {
// var respDTO = new DocumentResponse.No4McqDTO(modelData.exam(),
// modelData.elements(), modelData.teacher(),
// modelData.prevIndex(), modelData.nextIndex(), modelData.currentIndex());
// model.addAttribute("model", respDTO);
// return "document/no4-mcq";
// } else {
// var respDTO = new DocumentResponse.No4RubricDTO(modelData.exam(),
// modelData.elements(), modelData.teacher(),
// modelData.prevIndex(), modelData.nextIndex(), modelData.currentIndex());
// model.addAttribute("model", respDTO);
...
// var respDTO = new DocumentResponse.No5DTO(modelData.exams(),
// modelData.reExams(), modelData.teacher());
// model.addAttribute("model", respDTO);
// return "document/no5";
// }
// }